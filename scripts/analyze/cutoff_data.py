...
if __name__ == '__main__':
    ...
    analyze_cutoff('results/raw/cutoff_merge.txt', 'results/txt/cutoff_merge.txt', 'results/img/cutoff_merge.png')
    analyze_cutoff( 'results/raw/cutoff_sort.txt',  'results/txt/cutoff_sort.txt',  'results/img/cutoff_sort.png')
