...
def plot_and_save(x, y1, y2, y3, saveto):
    ...
    plt.plot(x, y2, linestyle='-', marker='o', label='Parallel')
    plt.plot(x, y3, linestyle='-', marker='o', label='STL')
...
if __name__ == '__main__':
    ...
    analyze_perf('results/raw/perf_merge_s.txt', 'results/txt/perf_merge_s.txt', 'results/img/perf_merge_s.png')
    analyze_perf('results/raw/perf_merge_l.txt', 'results/txt/perf_merge_l.txt', 'results/img/perf_merge_l.png')
    analyze_perf( 'results/raw/perf_sort_s.txt',  'results/txt/perf_sort_s.txt',  'results/img/perf_sort_s.png')
    analyze_perf( 'results/raw/perf_sort_l.txt',  'results/txt/perf_sort_l.txt',  'results/img/perf_sort_l.png')
